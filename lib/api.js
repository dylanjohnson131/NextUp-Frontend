// Fetch stats for a specific player and game
export async function fetchPlayerGameStats(gameId, playerId) {
  return req(`/api/stats/game/${gameId}/player/${playerId}`);
}
// Update player stats for a specific game
export async function updatePlayerStats(gameId, playerId, statsData) {
  return req(`/api/stats/game/${gameId}/player/${playerId}`, {
    method: 'POST',
